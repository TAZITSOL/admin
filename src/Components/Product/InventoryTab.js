     ...
     {values['product_type'] == "external" &&
      ...
      <SimpleInputField nameList={[
       ...
       {values["type"] === "simple" && <SimpleInputField nameList={[
        { name: "price", type: "number", inputaddon: "true", placeholder: t("enter_price") },
        { name: "discount", type: "number", inputaddon: "true", postprefix: "%", placeholder: t("enter_discount"), min: "0", max: "100" },
              ...
              render={(arrayHelpers) => {
                return (
                  <>
                          ...
                          <Col xs="12">
                            <Row className="g-sm-4 g-3 align-items-center attribute-row">
                              ...
                              <Col sm="2" className="delete-variant">
                                <a className="" onClick={() => arrayHelpers.remove(i)}>{t("remove")}</a>
                              </Col>
                              {/* )} */}
                            </Row>
                          </Col>
                    ...
                    <Btn className="btn-theme mt-4" color="transparent" onClick={() => arrayHelpers.push({ external_details: "" })} title="add_external_details" />
                    {/* </Col> */}
                  </>
                );
              }}
