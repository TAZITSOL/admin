    ...
    <>
          <div className="variant-row variant-row-2">
            ...
            {values["wholesale_price_type"] === "fixed" &&
              <SimpleInputField nameList={[
                { name: `wholesale_prices[${index}][value]`, title: "price", placeholder: t("enter_price"), type: "number", inputaddon: "true", min: "0" }]}
              />
            }
            {values["wholesale_price_type"] === "percentage" &&
              <SimpleInputField nameList={[
                { name: `wholesale_prices[${index}][value]`, title: "percentage", type: "number", min: '0', max: '100', inputaddon: "true", placeholder: "enter_percentage", postprefix: "%",  }]}
              />
            }
