    ...
    <div className="shipping-accordion-custom" key={index}>
      ...
      {active === elem.id && (
        <div className="rule-edit-form">
          <SimpleInputField
            nameList={[
              { name: `variations[${index}][name]`, title: "name", placeholder: "enter_name", require: "true", errormsg: "Name" },
              { name: `variations[${index}][price]`, title: "price", type: "number", placeholder: "enter_price", require: "true", inputaddon: "true", errormsg: "Price", min: "0" },
              { name: `variations[${index}][discount]`, title: "discount", type: "number", min: "0", max: "100", inputaddon: "true", placeholder: "enter_discount", postprefix: "%" },
              { name: `variations[${index}][sale_price]`, title: "sale_price", type: "number", inputaddon: "true", placeholder: "0.00", readOnly: true },
              { name: `variations[${index}][quantity]`, title: "stock_quantity", type: "number", require: "true", errormsg: "Quantity", placeholder: "enter_quantity" },
              { name: `variations[${index}][sku]`, title: "sku", require: "true", placeholder: "enter_sku", errormsg: "SKU" },
            ]}
          />
