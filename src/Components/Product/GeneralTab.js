...
const GeneralTab = ({ values, setFieldValue, updateId }) => {
  ...
  return (
    <>
      ...
      <SimpleInputField
        nameList={[
          { name: "name", require: "true", placeholder: t("enter_name"), value: values.name, onChange: (e) => { const nameValue = e.target.value; setFieldValue("name", nameValue); if (!updateId) { setFieldValue("slug", generateSlug(nameValue));}}, }, 
