...
const PerfumeHomePageSubmit = (values, mutate) => {
  ...
  if (values["collectionBannerImage"]) {
    values["content"]["collection_banner"]["image_url"] = values[`collectionBannerImage`].hasOwnProperty('asset_url') ? values[`collectionBannerImage`].asset_url : values[`collectionBannerImage`].original_url;
