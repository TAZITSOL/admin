 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  values["content"]["details_section"]["banners"].forEach((elem, i) => {
    if (values[`detailsSectionImage${i}`]) {
      values["content"]["details_section"]["banners"][i]["image_url"] = values[`detailsSectionImage${i}`].hasOwnProperty('asset_url') ? values[`detailsSectionImage${i}`].asset_url : values[`detailsSectionImage${i}`].original_url;
    } else {
  ...
  if (values["offerBanner1Image"]) {
    values["content"]["offer_banner"]["banner"]["banner_1"]["image_url"] = values[`offerBanner1Image`].hasOwnProperty('asset_url') ? values[`offerBanner1Image`].asset_url : values[`offerBanner1Image`].original_url;
  } else values["content"]["offer_banner"]["banner"]["banner_1"]["image_url"] = "";

  if (values["offerBanner2Image"]) {
    values["content"]["offer_banner"]["banner"]["banner_2"]["image_url"] = values[`offerBanner2Image`].hasOwnProperty('asset_url') ? values[`offerBanner2Image`].asset_url : values[`offerBanner2Image`].original_url;
  } else values["content"]["offer_banner"]["banner"]["banner_2"]["image_url"] = "";

  if (values["categoryProductImage"]) {
    values["content"]["category_product"]["image_url"] = values[`categoryProductImage`].hasOwnProperty('asset_url') ? values[`categoryProductImage`].asset_url : values[`categoryProductImage`].original_url;
