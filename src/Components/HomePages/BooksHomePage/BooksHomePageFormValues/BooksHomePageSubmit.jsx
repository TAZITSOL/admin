...
const BooksHomePageSubmit = (values, mutate) => {
  ...
  if (values["sliderProductImage"]) {
    values["content"]["slider_products"]["image_url"] = values["sliderProductImage"].hasOwnProperty('asset_url') ? values["sliderProductImage"].asset_url : values["sliderProductImage"].original_url;
