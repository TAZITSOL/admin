...
const VegetableFourSubmit = (values, mutate) => {
  ...
  values["content"]["offer_banner_2"]["banners"].forEach((elem, i) => {
    if (values[`offerBanner2Image${i}`]) {
      values["content"]["offer_banner_2"]["banners"][i]["image_url"] = values[`offerBanner2Image${i}`].hasOwnProperty('asset_url') ? values[`offerBanner2Image${i}`].asset_url : values[`offerBanner2Image${i}`].original_url;
    } else {
  ...
  if (values["homeBannerImage"]) {
    values["content"]["home_banner"]["image_url"] = values[`homeBannerImage${i}`].hasOwnProperty('asset_url') ? values[`homeBannerImage${i}`].asset_url : values[`homeBannerImage${i}`].original_url;
