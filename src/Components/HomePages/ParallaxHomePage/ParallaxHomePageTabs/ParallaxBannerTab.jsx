...
const ParallaxBannerTab = ({ values, setFieldValue, productData, categoryData, setSearch }) => {
  ...
  return (
    <>
      {<Btn className="btn-theme my-4" onClick={() => setFieldValue("[content][parallax_banner][banners]", [...values["content"]?.["parallax_banner"]["banners"], { title: "", description: "" }])} title="add_banners" />}
              ...
              <div className="shipping-accordion-custom">
                ...
                {active == index && (
                  <div className="rule-edit-form">
                    <SimpleInputField
                      nameList={[
                        { name: `[content][parallax_banner][banners][${index}][main_title]`, placeholder: t("enter_main_title"), title: "main_title" },
                        { name: `[content][parallax_banner][banners][${index}][title]`, placeholder: t("enter_title"), title: "title" },
                        { name: `[content][parallax_banner][banners][${index}][sub_title]`, placeholder: t("enter_sub_title"), title: "sub_title" },
                      ]}
                    />
