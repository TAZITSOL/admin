...
const GogglesHomePageSubmit = (values, mutate) => {
 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  if (values["offerBanner1Image"]) {
    values["content"]["offer_banner"]["banner_1"]["image_url"] = values["offerBanner1Image"].hasOwnProperty('asset_url') ? values["offerBanner1Image"].original_url : values["offerBanner1Image"].original_url;
  } else values["content"]["offer_banner"]["banner_1"]["image_url"] = "";

  if (values["offerBanner2Image"]) {
    values["content"]["offer_banner"]["banner_2"]["image_url"] = values["offerBanner2Image"].hasOwnProperty('asset_url') ? values["offerBanner2Image"].original_url : values["offerBanner2Image"].original_url;
  } else values["content"]["offer_banner"]["banner_2"]["image_url"] = "";

  if (values["offerBanner3Image"]) {
    values["content"]["offer_banner"]["banner_3"]["image_url"] = values["offerBanner3Image"].hasOwnProperty('asset_url') ? values["offerBanner3Image"].original_url : values["offerBanner3Image"].original_url;
  } else values["content"]["offer_banner"]["banner_3"]["image_url"] = "";

  if (values["fullBannerImage"]) {
    values["content"]["full_banner"]["image_url"] = values["fullBannerImage"].hasOwnProperty('asset_url') ? values["fullBannerImage"].original_url : values["fullBannerImage"].original_url;
