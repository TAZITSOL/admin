 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  values["content"]["grid_banner"]["banners"].forEach((elem, i) => {
    if (values[`gridBannerImage${i}`]) {
      {
        i !== 0 ? (values["content"]["grid_banner"]["banners"][i]["image_url"] = values[`gridBannerImage${i}`].hasOwnProperty('asset_url') ? values[`gridBannerImage${i}`].asset_url : values[`gridBannerImage${i}`].original_url) : (values["content"]["grid_banner"]["banners"][i]["video_url"] = values[`gridBannerImage${i}`].hasOwnProperty('asset_url') ? values[`gridBannerImage${i}`].asset_url : values[`gridBannerImage${i}`].original_url);
      }
    } else {
      {
  ...
  if (values["productList2Banner1Image"]) {
    values["content"]["product_list_2"]["products"]["product_banner"]["banner_1"]["image_url"] = values["productList2Banner1Image"].hasOwnProperty('asset_url')  ? values["productList2Banner1Image"].asset_url : values["productList2Banner1Image"].original_url;
  } else values["content"]["product_list_2"]["products"]["product_banner"]["banner_1"]["image_url"] = "";

  if (values["productList2Banner2Image"]) {
    values["content"]["product_list_2"]["products"]["product_banner"]["banner_2"]["image_url"] = values["productList2Banner2Image"].hasOwnProperty('asset_url')  ? values["productList2Banner2Image"].asset_url : values["productList2Banner2Image"].original_url;
