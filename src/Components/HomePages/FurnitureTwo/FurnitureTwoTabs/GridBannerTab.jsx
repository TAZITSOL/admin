...
const GridBannerTab = ({ values, setFieldValue, productData, categoryData, setSearch }) => {
  ...
  return (
    <>
      {<Btn className="btn-theme my-4" onClick={() => setFieldValue("[content][grid_banner][banners]", [...values["content"]?.["grid_banner"]["banners"], { title: "", description: "" }])} title="add_banners" />}
                ...
                <div className="shipping-accordion-custom">
                  ...
                  {active == index && (
                    <div className="rule-edit-form">
                      <SimpleInputField
                        nameList={[
                          { name: `[content][grid_banner][banners][${index}][tag]`, placeholder: t("enter_title"), title: "title" },
                          { name: `[content][grid_banner][banners][${index}][title]`, placeholder: t("enter_title"), title: "title" },
                          { name: `[content][grid_banner][banners][${index}][button_text]`, placeholder: t("enter_title"), title: "title" },
                        ]}
                      />
