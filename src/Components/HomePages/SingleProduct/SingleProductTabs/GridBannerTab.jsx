...
import { GridBannerTabs } from "@/Data/TabTitleListData";
...
const GridBannerTab = ({ values, setFieldValue, productData, categoryData, setSearch }) => {
  ...
  return (
    <div className="inside-horizontal-tabs">
      <TabTitle activeTab={activeTab} setActiveTab={setActiveTab} titleList={GridBannerTabs} />
      <TabContent activeTab={activeTab}>
        <TabPane tabId="1">
          ...
          <CheckBoxField name={`[content][grid_banner][banner_1][status]`} title="status" />
        </TabPane>
        <TabPane tabId="2">
          ...
          <CommonRedirect values={values} setFieldValue={setFieldValue} productData={productData} categoryData={categoryData} nameList={{ selectNameKey: "banner3LinkType", multipleNameKey: "banner2Link" }} setSearch={setSearch} />
          <CheckBoxField name={`[content][grid_banner][banner_2][status]`} title="status" />
        </TabPane>
        <TabPane tabId="3">
          ...
          <CheckBoxField name={`[content][grid_banner][banner_3][status]`} title="status" />
        </TabPane>
      </TabContent>
    </div>
  );
