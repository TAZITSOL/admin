...
const ToolsHomePageSubmit = (values, mutate) => {
 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  if (values["categoryRightContentImage"]) {
    values["content"]["category_product"]["right_panel"]["product_banner"]["image_url"] = values[`categoryRightContentImage`].hasOwnProperty('asset_url') ? values[`categoryRightContentImage`].asset_url : values[`categoryRightContentImage`].original_url;
  } else values["content"]["category_product"]["right_panel"]["product_banner"]["image_url"] = "";

  if (values["productList2Image"]) {
    values["content"]["products_list_2"]["image_url"] = values[`productList2Image`].hasOwnProperty('asset_url') ? values[`productList2Image`].asset_url : values[`productList2Image`].original_url;
  }
