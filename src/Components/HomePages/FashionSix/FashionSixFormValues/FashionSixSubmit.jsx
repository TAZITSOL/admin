...
const FashionSixSubmit = (values, mutate) => {
 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  if (values["banner1Image"]) {
    values["content"]["offer_banner"]["banner_1"]["image_url"] = values["banner1Image"].hasOwnProperty('asset_url') ? values["banner1Image"].asset_url : values["banner1Image"].original_url;
  } else values["content"]["offer_banner"]["banner_1"]["image_url"] = "";

  if (values["banner2Image"]) {
    values["content"]["offer_banner"]["banner_2"]["image_url"] = values["banner2Image"].hasOwnProperty('asset_url') ? values["banner2Image"].asset_url : values["banner2Image"].original_url;
  } else values["content"]["offer_banner"]["banner_2"]["image_url"] = "";

  if (values["banner3Image"]) {
    values["content"]["offer_banner"]["banner_3"]["image_url"] = values["banner3Image"].hasOwnProperty('asset_url') ? values["banner3Image"].asset_url : values["banner3Image"].original_url;
  } else values["content"]["offer_banner"]["banner_3"]["image_url"] = "";

  if (values["banner4Image"]) {
    values["content"]["offer_banner"]["banner_4"]["image_url"] = values["banner4Image"].hasOwnProperty('asset_url') ? values["banner4Image"].asset_url : values["banner4Image"].original_url;
  } else values["content"]["offer_banner"]["banner_4"]["image_url"] = "";

  if (values["banner5Image"]) {
    values["content"]["offer_banner"]["banner_5"]["image_url"] = values["banner5Image"].hasOwnProperty('asset_url') ? values["banner5Image"].asset_url : values["banner5Image"].original_url;
  } else values["content"]["offer_banner"]["banner_5"]["image_url"] = "";

  if (values["banner6Image"]) {
    values["content"]["offer_banner"]["banner_6"]["image_url"] = values["banner6Image"].hasOwnProperty('asset_url') ? values["banner6Image"].asset_url : values["banner6Image"].original_url;
  } else values["content"]["offer_banner"]["banner_6"]["image_url"] = "";

  if (values["rightPanelImage"]) {
    values["content"]["products_list_2"]["right_panel"]["image_url"] = values["rightPanelImage"].hasOwnProperty('asset_url') ? values["rightPanelImage"].asset_url : values["rightPanelImage"].original_url;
  } else values["content"]["products_list_2"]["right_panel"]["image_url"] = "";

  if (values["sliderProductImage"]) {
    values["content"]["product_banner"]["image_url"] = values["sliderProductImage"].hasOwnProperty('asset_url') ? values["sliderProductImage"].asset_url : values["sliderProductImage"].original_url;
