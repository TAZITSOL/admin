    ...
    <>
        ...
        {active == 4 && (
          <>
            <div className="rule-edit-form">
              <SimpleInputField nameList={[{ name: "[content][categories_products][right_panel][products_list][title]", placeholder: t("enter_title"), title: "title" }]} />
      ...
      <div className="shipping-accordion-custom">
        ...
        {active == 6 && (
          <>
            <div className="rule-edit-form">
              <SimpleInputField nameList={[{ name: "[content][categories_products][right_panel][category_product][title]", placeholder: t("enter_title"), title: "title" }]} />
