...
const MarketplaceThreeSubmit = (values, mutate) => {
 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  if (values["categoryLeftContentBannerImage"]) {
    values["content"]["categories_products"]["left_panel"]["banner"]["image_url"] = values[`categoryLeftContentBannerImage`].hasOwnProperty('asset_url') ? values[`categoryLeftContentBannerImage`].asset_url : values[`categoryLeftContentBannerImage`].original_url;
  } else values["content"]["categories_products"]["left_panel"]["banner"]["image_url"] = "";

  if (values["categoryProductOfferBanner1Image"]) {
    values["content"]["categories_products"]["right_panel"]["offer_banner"]["banner_1"]["image_url"] = values[`categoryProductOfferBanner1Image`].hasOwnProperty('asset_url') ? values[`categoryProductOfferBanner1Image`].asset_url : values[`categoryProductOfferBanner1Image`].original_url;
  ...
  if (values["categoryProductOfferBanner2Image"]) {
    values["content"]["categories_products"]["right_panel"]["offer_banner"]["banner_2"]["image_url"] = values[`categoryProductOfferBanner2Image`].hasOwnProperty('asset_url') ? values[`categoryProductOfferBanner2Image`].asset_url : values[`categoryProductOfferBanner2Image`].original_url;
