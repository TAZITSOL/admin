...
const ElectronicsThreeSubmit = (values, mutate) => {
 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  if (values["banner1Image"]) {
    values["content"]["banner"]["main_banner"]["image_url"] = values["banner1Image"].hasOwnProperty('asset_url') ? values["banner1Image"].asset_url : values["banner1Image"].original_url;
  } else values["content"]["banner"]["main_banner"]["image_url"] = "";

  if (values["banner2Image"]) {
    values["content"]["banner"]["grid_banner_1"]["image_url"] = values["banner2Image"].hasOwnProperty('asset_url') ? values["banner2Image"].asset_url : values["banner2Image"].original_url;
  } else values["content"]["banner"]["grid_banner_1"]["image_url"] = "";

  if (values["banner3Image"]) {
    values["content"]["banner"]["grid_banner_2"]["image_url"] = values["banner3Image"].hasOwnProperty('asset_url') ? values["banner3Image"].asset_url : values["banner3Image"].original_url;
  } else values["content"]["banner"]["grid_banner_2"]["image_url"] = "";

  if (values["banner4Image"]) {
    values["content"]["banner"]["grid_banner_3"]["image_url"] = values["banner4Image"].hasOwnProperty('asset_url') ? values["banner4Image"].asset_url : values["banner4Image"].original_url;
  ...
  if (values["offerBannerImage"]) {
    values["content"]["offer_banner_1"]["image_url"] = values["offerBannerImage"].hasOwnProperty('asset_url') ? values["offerBannerImage"].asset_url : values["offerBannerImage"].original_url;
