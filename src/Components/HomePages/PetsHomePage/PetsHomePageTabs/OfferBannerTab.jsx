...
const OfferBannerTab = ({ values, setFieldValue, productData, categoryData, setSearch }) => {
  ...
  return (
    <>
      {<Btn className="btn-theme my-4" onClick={() => setFieldValue("[content][offer_banner][banners]", [...values["content"]?.["offer_banner"]["banners"], { title: "", description: "" }])} title="add_banners" />}
