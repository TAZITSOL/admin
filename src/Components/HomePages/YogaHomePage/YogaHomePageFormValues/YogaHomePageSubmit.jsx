...
const YogaHomePageSubmit = (values, mutate) => {
  ...
  if (values["homeBannerImage"]) {
    values["content"]["home_banner"]["image_url"] = values[`homeBannerImage`].hasOwnProperty('asset_url') ? values[`homeBannerImage`].asset_url : values[`homeBannerImage`].original_url;
  } else values["content"]["home_banner"]["image_url"] = "";

  if (values["offerBanner1Image1"]) {
    values["content"]["offer_banner_1"]["banner_1"]["image_url"] = values[`offerBanner1Image1`].hasOwnProperty('asset_url') ? values[`offerBanner1Image1`].asset_url : values[`offerBanner1Image1`].original_url;
  } else values["content"]["offer_banner_1"]["banner_1"]["image_url"] = "";

  if (values["offerBanner1Image2"]) {
    values["content"]["offer_banner_1"]["banner_2"]["image_url"] = values[`offerBanner1Image2`].hasOwnProperty('asset_url') ? values[`offerBanner1Image2`].asset_url : values[`offerBanner1Image2`].original_url;
  } else values["content"]["offer_banner_1"]["banner_2"]["image_url"] = "";

  if (values["offerBanner1Image3"]) {
    values["content"]["offer_banner_1"]["banner_3"]["image_url"] = values[`offerBanner1Image3`].hasOwnProperty('asset_url') ? values[`offerBanner1Image3`].asset_url : values[`offerBanner1Image3`].original_url;
  } else values["content"]["offer_banner_1"]["banner_3"]["image_url"] = "";

  if (values["offerBanner2Image1"]) {
    values["content"]["offer_banner_2"]["banner_1"]["image_url"] = values[`offerBanner2Image1`].hasOwnProperty('asset_url') ? values[`offerBanner2Image1`].asset_url : values[`offerBanner2Image1`].original_url;
  } else values["content"]["offer_banner_2"]["banner_1"]["image_url"] = "";

  if (values["offerBanner2Image2"]) {
    values["content"]["offer_banner_2"]["banner_2"]["image_url"] = values[`offerBanner2Image2`].hasOwnProperty('asset_url') ? values[`offerBanner2Image2`].asset_url : values[`offerBanner2Image2`].original_url;
  } else values["content"]["offer_banner_2"]["banner_2"]["image_url"] = "";

  if (values["productBanner1Image"]) {
    values["content"]["product_banner"]["post_banner"]["banner_1"]["image_url"] = values[`productBanner1Image`].hasOwnProperty('asset_url') ? values[`productBanner1Image`].asset_url : values[`productBanner1Image`].original_url;
  } else values["content"]["product_banner"]["post_banner"]["banner_1"]["image_url"] = "";

  if (values["productBanner2Image"]) {
    values["content"]["product_banner"]["post_banner"]["banner_2"]["image_url"] = values[`productBanner2Image`].hasOwnProperty('asset_url') ? values[`productBanner2Image`].asset_url : values[`productBanner2Image`].original_url;
