 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  values["content"]["banner"]["banners"].forEach((elem, i) => {
    if (values[`bannerImage${i}`]) {
      values["content"]["banner"]["banners"][i]["image_url"] = values[`bannerImage${i}`].hasOwnProperty('asset_url') ? values[`bannerImage${i}`].asset_url : values[`bannerImage${i}`].original_url;
    } else {
  ...
  if (values["offerBannerImage"]) {
    values["content"]["offer_banner"]["image_url"] = values[`offerBannerImage`].hasOwnProperty('asset_url') ? values[`offerBannerImage`].asset_url : values[`offerBannerImage`].original_url;
