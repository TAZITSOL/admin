...
const OfferBanner1Tab = ({ values, setFieldValue, productData, categoryData, setSearch }) => {
  ...
  return (
    <>
      {<Btn className="btn-theme my-4" onClick={() => setFieldValue("[content][offer_banner_1][banners]", [...values["content"]?.["offer_banner_1"]["banners"], { title: "", description: "" }])} title="add_banners" />}
