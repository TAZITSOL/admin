...
const JwelleryTwoSubmit = (values, mutate) => {
  ...
  values["content"]["offer_banner_1"]["banners"].forEach((elem, i) => {
    ...
    if (values[`offerBanner1Image${i}`]) {
      values["content"]["offer_banner_1"]["banners"][i]["image_url"] = values[`offerBanner1Image${i}`].hasOwnProperty('asset_url') ? values[`offerBanner1Image${i}`].asset_url : values[`offerBanner1Image${i}`].original_url;
    } else {
  ...
  if (values["banner1Image"]) {
    values["content"]["banner"]["image_url"] = values["banner1Image"].hasOwnProperty('asset_url') ? values["banner1Image"].asset_url : values["banner1Image"].original_url;
  ...
  if (values["productBannerCenterContentImage1"]) {
    values["content"]["product_banner"]["center_panel"]["banner_1"]["image_url"] = values["productBannerCenterContentImage1"].hasOwnProperty('asset_url') ? values["productBannerCenterContentImage1"].asset_url : values["productBannerCenterContentImage1"].original_url;
  } else values["content"]["product_banner"]["center_panel"]["banner_1"]["image_url"] = "";

  if (values["productBannerCenterContentImage2"]) {
    values["content"]["product_banner"]["center_panel"]["banner_2"]["image_url"] = values["productBannerCenterContentImage2"].hasOwnProperty('asset_url') ? values["productBannerCenterContentImage2"].asset_url : values["productBannerCenterContentImage2"].original_url;
