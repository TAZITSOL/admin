...
const BicycleHomePageSubmit = (values, mutate) => {
  ...
  if (values["offerBanner1Image2"]) {
    values["content"]["offer_banner"]["banner_2"]["image_url"] = values["offerBanner1Image2"].hasOwnProperty('asset_url') ? values["offerBanner1Image2"].asset_url : values["offerBanner1Image1"].original_url;
  } else values["content"]["offer_banner"]["banner_2"]["image_url"] = "";

  if (values["bannerImage"]) {
    values["content"]["banner"]["image_url"] = values["bannerImage"].hasOwnProperty('asset_url') ? values["bannerImage"].asset_url : values["bannerImage"].original_url;
  }
