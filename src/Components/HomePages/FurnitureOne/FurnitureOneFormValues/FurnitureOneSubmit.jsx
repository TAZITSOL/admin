...
const FurnitureOneSubmit = (values, mutate) => {
 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  if (values["featuredBanner1Image"]) {
    values["content"]["featured_banners"]["banner_1"]["image_url"] = values["featuredBanner1Image"].hasOwnProperty('asset_url') ? values["featuredBanner1Image"].asset_url : values["featuredBanner1Image"].original_url;
  } else values["content"]["featured_banners"]["banner_1"]["image_url"] = "";

  if (values["featuredBanner2Image"]) {
    values["content"]["featured_banners"]["banner_2"]["image_url"] = values["featuredBanner2Image"].hasOwnProperty('asset_url') ? values["featuredBanner2Image"].asset_url : values["featuredBanner2Image"].original_url;
  } else values["content"]["featured_banners"]["banner_2"]["image_url"] = "";

  if (values["categoriesIconImage"]) {
    values["content"]["parallax_banner"]["image_url"] = values["categoriesIconImage"].hasOwnProperty('asset_url') ? values["categoriesIconImage"].asset_url : values["categoriesIconImage"].original_url;
