...
const SurfingHomePageSubmit = (values, mutate) => {
 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  if (values["columnOfferBanner1Image"]) {
    values["content"]["column_banner_product"]["offer_banner_1"]["image_url"] = values[`columnOfferBanner1Image`].hasOwnProperty('asset_url') ? values[`columnOfferBanner1Image`].asset_url : values[`columnOfferBanner1Image`].original_url;
  } else values["content"]["column_banner_product"]["offer_banner_1"]["image_url"] = "";

  if (values["columnOfferBanner2Image"]) {
    values["content"]["column_banner_product"]["offer_banner_2"]["image_url"] = values[`columnOfferBanner2Image`].hasOwnProperty('asset_url') ? values[`columnOfferBanner2Image`].asset_url : values[`columnOfferBanner2Image`].original_url;
