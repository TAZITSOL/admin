...
const MarketplaceOneSubmit = (values, mutate) => {
 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  if (values["offerBanner2Image"]) {
    values["content"]["offer_banner_2"]["image_url"] = values[`offerBanner2Image`].hasOwnProperty('asset_url') ? values[`offerBanner2Image`].asset_url : values[`offerBanner2Image`].original_url;
  } else values["content"]["offer_banner_2"]["image_url"] = "";

  if (values["productList2Image"]) {
    values["content"]["category_product"]["right_panel"]["product_banner"]["image_url"] = values[`productList2Image`].hasOwnProperty('asset_url') ? values[`productList2Image`].asset_url : values[`productList2Image`].original_url;
