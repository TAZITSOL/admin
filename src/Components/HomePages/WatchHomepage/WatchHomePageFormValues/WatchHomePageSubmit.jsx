...
const WatchHomePageSubmit = (values, mutate) => {
 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  if (values["offerBanner1Image"]) {
    values["content"]["offer_banner_1"]["image_url"] = values[`offerBanner1Image`].hasOwnProperty('asset_url') ? values[`offerBanner1Image`].asset_url : values[`offerBanner1Image`].original_url;
  ...
  if (values["offerBanner2Image3"]) {
    values["content"]["offer_banner_2"]["banner_3"]["image_url"] = values[`offerBanner2Image3`].hasOwnProperty('asset_url') ? values[`offerBanner2Image3`].asset_url : values[`offerBanner2Image3`].original_url;
