...
const FashionTwoSubmit = (values, mutate) => {
 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  if (values["offerBanner4Image"]) {
    values["content"]["offer_banner"]["banner_4"]["image_url"] = values["offerBanner4Image"].hasOwnProperty('asset_url') ? values["offerBanner4Image"].asset_url : values["offerBanner4Image"].original_url;
  } else values["content"]["offer_banner"]["banner_4"]["image_url"] = "";

  if (values["fullBannerImage"]) {
    values["content"]["full_banner"]["image_url"] = values["fullBannerImage"].hasOwnProperty('asset_url') ? values["fullBannerImage"].asset_url : values["fullBannerImage"].original_url;
