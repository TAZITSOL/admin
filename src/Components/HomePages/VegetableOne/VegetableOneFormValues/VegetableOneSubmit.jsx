...
const VegetableOneSubmit = (values, mutate) => {
 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  if (values["parallaxBannerImage"]) {
    values["content"]["parallax_banner"]["image_url"] = values[`parallaxBannerImage`].hasOwnProperty('asset_url') ? values[`parallaxBannerImage`].asset_url : values[`parallaxBannerImage`].original_url;
