...
const ShoesHomePageSubmit = (values, mutate) => {
 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  if (values["aboutBanner1Image"]) {
    values["content"]["about_banner"]["collection_banner"]["banner_1"]["image_url"] = values[`aboutBanner1Image`].hasOwnProperty('asset_url') ? values[`aboutBanner1Image`].asset_url : values[`aboutBanner1Image`].original_url;
  } else values["content"]["about_banner"]["collection_banner"]["banner_1"]["image_url"] = "";

  if (values["aboutBanner2Image"]) {
    values["content"]["about_banner"]["collection_banner"]["banner_2"]["image_url"] = values[`aboutBanner2Image`].hasOwnProperty('asset_url') ? values[`aboutBanner2Image`].asset_url : values[`aboutBanner2Image`].original_url;
