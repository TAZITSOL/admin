...
const FashionSevenSubmit = (values, mutate) => {
  ...
  if (values["banner1Image"]) {
    values["content"]["featured_banners"]["banner_1"]["image_url"] = values[`banner1Image`].hasOwnProperty('asset_url') ? values[`banner1Image`].asset_url : values[`banner1Image`].original_url;
  } else values["content"]["featured_banners"]["banner_1"]["image_url"] = "";

  if (values["banner2Image"]) {
    values["content"]["featured_banners"]["banner_2"]["image_url"] = values[`banner2Image`].hasOwnProperty('asset_url') ? values[`banner2Image`].asset_url : values[`banner2Image`].original_url;
  } else values["content"]["featured_banners"]["banner_2"]["image_url"] = "";

  if (values["banner3Image"]) {
    values["content"]["featured_banners"]["banner_3"]["image_url"] = values[`banner3Image`].hasOwnProperty('asset_url') ? values[`banner3Image`].asset_url : values[`banner3Image`].original_url;
  } else values["content"]["featured_banners"]["banner_3"]["image_url"] = "";

  if (values["productBannerImage"]) {
    values["content"]["product_banner"]["image_url"] = values[`productBannerImage`].hasOwnProperty('asset_url') ? values[`productBannerImage`].asset_url : values[`productBannerImage`].original_url;
