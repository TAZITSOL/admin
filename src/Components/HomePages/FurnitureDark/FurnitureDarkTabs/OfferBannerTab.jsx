    ...
    <div className="inside-horizontal-tabs">
      ...
      <TabContent activeTab={activeTab}>
        <TabPane tabId="1">
          ...
          <SimpleInputField
            nameList={[
              { name: `[content][offer_banner][banner_1][title]`, placeholder: t("enter_tag"), title: "tags" },
              { name: `[content][offer_banner][banner_1][sub_title]`, placeholder: t("enter_title"), title: "title" },
            ]}
          />
        ...
        <TabPane tabId="2">
          ...
          <SimpleInputField
            nameList={[
              { name: `[content][offer_banner][banner_2][title]`, placeholder: t("enter_tag"), title: "tags" },
              { name: `[content][offer_banner][banner_2][sub_title]`, placeholder: t("enter_title"), title: "title" },
            ]}
          />
        ...
        <TabPane tabId="3">
          ...
          <SimpleInputField
            nameList={[
              { name: `[content][offer_banner][banner_3][title]`, placeholder: t("enter_tag"), title: "tags" },
              { name: `[content][offer_banner][banner_3][sub_title]`, placeholder: t("enter_title"), title: "title" },
            ]}
          />
