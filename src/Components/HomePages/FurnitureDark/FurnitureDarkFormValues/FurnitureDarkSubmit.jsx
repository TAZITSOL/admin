...
const FurnitureDarkSubmit = (values, mutate) => {
 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  if (values["offerBanner3Image"]) {
    values["content"]["offer_banner"]["banner_3"]["image_url"] = values["offerBanner3Image"].hasOwnProperty('asset_url') ? values["offerBanner3Image"].asset_url : values["offerBanner3Image"].original_url;
  } else values["content"]["offer_banner"]["banner_3"]["image_url"] = "";

  if (values["banner1Image"]) {
    values["content"]["banner"]["banner_1"]["image_url"] = values["banner1Image"].hasOwnProperty('asset_url') ? values["banner1Image"].asset_url : values["banner1Image"].original_url;
  } else values["content"]["banner"]["banner_1"]["image_url"] = "";

  if (values["banner2Image"]) {
    values["content"]["banner"]["banner_2"]["image_url"] = values["banner2Image"].hasOwnProperty('asset_url') ? values["banner2Image"].asset_url : values["banner2Image"].original_url;
  } else values["content"]["banner"]["banner_2"]["image_url"] = "";

  if (values["banner3Image"]) {
    values["content"]["banner"]["banner_3"]["image_url"] = values["banner3Image"].hasOwnProperty('asset_url') ? values["banner3Image"].asset_url : values["banner3Image"].original_url;
  } else values["content"]["banner"]["banner_3"]["image_url"] = "";

  if (values["leftPanelImage"]) {
    values["content"]["product_list_2"]["left_panel"]["image_url"] = values["leftPanelImage"].hasOwnProperty('asset_url') ? values["leftPanelImage"].asset_url : values["leftPanelImage"].original_url;
