...
const AboutUsTab = ({ values, setFieldValue }) => {
  ...
  return (
    <>
      <SimpleInputField
        nameList={[
          { name: `[content][about_us][title]`, placeholder: t("enter_title"), title: "title" },
          { name: `[content][about_us][description]`, placeholder: t("enter_description"), title: "description", type: "textarea" },
        ]}
      />
      ...
      {<Btn className="btn-theme my-4" onClick={() => setFieldValue("[content][about_us][services][banners]", [...values["content"]?.["about_us"]["services"]["banners"], { title: "", description: "" }])} title="add_banners" />}
              ...
              <div className="shipping-accordion-custom">
                ...
                {active == index && (
                  <div className="rule-edit-form">
                    <SimpleInputField nameList={[{ name: `[content][about_us][services][banners][${index}][title]`, placeholder: t("enter_title"), title: "title" }]} />
