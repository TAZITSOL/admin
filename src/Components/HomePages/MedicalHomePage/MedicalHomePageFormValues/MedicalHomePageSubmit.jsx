...
const MedicalHomePageSubmit = (values, mutate) => {
  ...
  values["content"]["offer_banner"]["banners"].forEach((elem, i) => {
    if (values[`offerBannerImage${i}`]) {
      values["content"]["offer_banner"]["banners"][i]["image_url"] = values[`offerBannerImage${i}`].hasOwnProperty('asset_url') ? values[`offerBannerImage${i}`].asset_url : values[`offerBannerImage${i}`].original_url;
    } else {
  ...
  if (values["offerBanner1Image"]) {
    values["content"]["column_banner_product"]["offer_banner_1"]["image_url"] = values[`offerBanner1Image`].hasOwnProperty('asset_url') ? values[`offerBanner1Image`].asset_url : values[`offerBanner1Image`].original_url;
  } else values["content"]["column_banner_product"]["offer_banner_1"]["image_url"] = "";

  if (values["offerBanner2Image"]) {
    values["content"]["column_banner_product"]["offer_banner_2"]["image_url"] = values[`offerBanner2Image`].hasOwnProperty('asset_url') ? values[`offerBanner2Image`].asset_url : values[`offerBanner2Image`].original_url;
