  ...
  return (
    <div className="inside-horizontal-tabs">
      ...
      <TabContent activeTab={activeTab}>
        ...
        <TabPane tabId="2">
          <SimpleInputField nameList={[{ name: `[content][column_banner_product][product_list_1][title]`, placeholder: t("enter_title"), title: "title" }]} />
        ...
        <TabPane tabId="4">
          <SimpleInputField nameList={[{ name: `[content][column_banner_product][product_list_2][title]`, placeholder: t("enter_title"), title: "title" }]} />
          <SearchableSelectInput
            nameList={[
              {
