...
const JwelleryThreeSubmit = (values, mutate) => {
 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  if (values["productBannerCenterContentImage1"]) {
    values["content"]["product_banner"]["center_panel"]["image_url"] = values["productBannerCenterContentImage1"].hasOwnProperty('asset_url') ? values["productBannerCenterContentImage1"].asset_url : values["productBannerCenterContentImage1"].original_url;
  } else values["content"]["product_banner"]["center_panel"]["image_url"] = "";

  if (values["offerBanner1Image1"]) {
    values["content"]["offer_banner"]["banner_1"]["image_url"] = values["offerBanner1Image1"].hasOwnProperty('asset_url') ? values["offerBanner1Image1"].asset_url : values["offerBanner1Image1"].original_url;
  } else values["content"]["offer_banner"]["banner_1"]["image_url"] = "";

  if (values["offerBanner1Image2"]) {
    values["content"]["offer_banner"]["banner_2"]["image_url"] = values["offerBanner1Image2"].hasOwnProperty('asset_url') ? values["offerBanner1Image2"].asset_url : values["offerBanner1Image2"].original_url;
  } else values["content"]["offer_banner"]["banner_2"]["image_url"] = "";

  if (values["offerBanner1Image3"]) {
    values["content"]["offer_banner"]["banner_3"]["image_url"] = values["offerBanner1Image3"].hasOwnProperty('asset_url') ? values["offerBanner1Image3"].asset_url : values["offerBanner1Image3"].original_url;
  } else values["content"]["offer_banner"]["banner_3"]["image_url"] = "";

  if (values["mainBannerImage"]) {
    values["content"]["main_banner"]["image_url"] = values["mainBannerImage"].hasOwnProperty('asset_url') ? values["mainBannerImage"].asset_url : values["mainBannerImage"].original_url;
