...
const GradientHomePageSubmit = (values, mutate) => {
 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  if (values["parallaxBanner1Image"]) {
    values["content"]["parallax_banner"]["banner_1"]["image_url"] = values["parallaxBanner1Image"].hasOwnProperty('asset_url') ? values["parallaxBanner1Image"].asset_url : values["parallaxBanner1Image"].original_url;
  } else values["content"]["parallax_banner"]["banner_1"]["image_url"] = "";

  if (values["parallaxBanner2Image"]) {
    values["content"]["parallax_banner"]["banner_2"]["image_url"] = values["parallaxBanner2Image"].hasOwnProperty('asset_url') ? values["parallaxBanner2Image"].asset_url : values["parallaxBanner2Image"].original_url;
