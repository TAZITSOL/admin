    ...
    <div className="inside-horizontal-tabs">
      ...
      <TabContent activeTab={activeTab}>
        <TabPane tabId="1">
          <SimpleInputField
            nameList={[
              { name: `[content][collection_banner][banner_1][tag]`, placeholder: t("enter_tag"), title: "tags" },
              { name: `[content][collection_banner][banner_1][title]`, placeholder: t("enter_title"), title: "title" },
            ]}
          />
        ...
        <TabPane tabId="2">
          <SimpleInputField
            nameList={[
              { name: `[content][collection_banner][banner_2][tag]`, placeholder: t("enter_tag"), title: "tags" },
              { name: `[content][collection_banner][banner_2][title]`, placeholder: t("enter_title"), title: "title" },
            ]}
          />
        ...
        <TabPane tabId="3">
          <SimpleInputField
            nameList={[
              { name: `[content][collection_banner][banner_3][tag]`, placeholder: t("enter_tag"), title: "tags" },
              { name: `[content][collection_banner][banner_3][title]`, placeholder: t("enter_title"), title: "title" },
            ]}
          />
