...
const VideoSliderSubmit = (values, mutate) => {
 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  if (values["fullBannerImage"]) {
    values["content"]["parallax_banner"]["image_url"] = values[`fullBannerImage`].hasOwnProperty('asset_url') ? values[`fullBannerImage`].asset_url : values[`fullBannerImage`].original_url;
  } else values["content"]["parallax_banner"]["image_url"] = "";

  if (values["collectionBanner1Image"]) {
    values["content"]["collection_banner"]["banner_1"]["image_url"] = values[`collectionBanner1Image`].hasOwnProperty('asset_url') ? values[`collectionBanner1Image`].asset_url : values[`collectionBanner1Image`].original_url;
  } else values["content"]["collection_banner"]["banner_1"]["image_url"] = "";

  if (values["collectionBanner2Image"]) {
    values["content"]["collection_banner"]["banner_2"]["image_url"] = values[`collectionBanner2Image`].hasOwnProperty('asset_url') ? values[`collectionBanner2Image`].asset_url : values[`collectionBanner2Image`].original_url;
  } else values["content"]["collection_banner"]["banner_2"]["image_url"] = "";

  if (values["collectionBanner3Image"]) {
    values["content"]["collection_banner"]["banner_3"]["image_url"] = values[`collectionBanner3Image`].hasOwnProperty('asset_url') ? values[`collectionBanner3Image`].asset_url : values[`collectionBanner3Image`].original_url;
