 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  values["content"]["services"]["banners"].forEach((elem, i) => {
    if (values[`serviceBannerImage${i}`]) {
      values["content"]["services"]["banners"][i]["image_url"] = values[`serviceBannerImage${i}`].hasOwnProperty('asset_url') ? values[`serviceBannerImage${i}`].asset_url : values[`serviceBannerImage${i}`].original_url;
    } else {
  ...
  if (values["offerBanner1Image4"]) {
    values["content"]["offer_banner_1"]["banner_4"]["image_url"] = values[`offerBanner1Image4`].hasOwnProperty('asset_url') ? values[`offerBanner1Image4`].asset_url : values[`offerBanner1Image4`].original_url;
  ...
  if (values["offerBanner3Image"]) {
    values["content"]["offer_banner_3"]["image_url"] = values[`offerBanner3Image`].hasOwnProperty('asset_url') ? values[`offerBanner3Image`].asset_url : values[`offerBanner3Image`].original_url;
