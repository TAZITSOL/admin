...
const MarketplaceFourSubmit = (values, mutate) => {
 ...
 if (!values["content"]["home_banner"]["banners"][i]["redirect_link"]) {
  ...
  if (values["productBanner1LeftContentImage"]) {
    values["content"]["product_banner_1"]["left_panel"]["image_url"] = values[`productBanner1LeftContentImage`].hasOwnProperty('asset_url') ? values[`productBanner1LeftContentImage`].asset_url : values[`productBanner1LeftContentImage`].original_url;
  } else values["content"]["product_banner_1"]["left_panel"]["image_url"] = "";

  if (values["productBanner3LeftContentImage"]) {
    values["content"]["product_banner_3"]["left_panel"]["image_url"] = values[`productBanner3LeftContentImage`].hasOwnProperty('asset_url') ? values[`productBanner3LeftContentImage`].asset_url : values[`productBanner3LeftContentImage`].original_url;
  } else values["content"]["product_banner_3"]["left_panel"]["image_url"] = "";

  if (values["productBanner2Image1"]) {
    values["content"]["product_banner_2"]["center_panel"]["banner_1"]["image_url"] = values[`productBanner2Image1`].hasOwnProperty('asset_url') ? values[`productBanner2Image1`].asset_url : values[`productBanner2Image1`].original_url;
  } else values["content"]["product_banner_2"]["center_panel"]["banner_1"]["image_url"] = "";

  if (values["productBanner2Image2"]) {
    values["content"]["product_banner_2"]["center_panel"]["banner_2"]["image_url"] = values[`productBanner2Image2`].hasOwnProperty('asset_url') ? values[`productBanner2Image2`].asset_url : values[`productBanner2Image2`].original_url;
  } else values["content"]["product_banner_2"]["center_panel"]["banner_2"]["image_url"] = "";

  if (values["productSliderImage"]) {
    values["content"]["slider_products"]["image_url"] = values[`productSliderImage`].hasOwnProperty('asset_url') ? values[`productSliderImage`].asset_url : values[`productSliderImage`].original_url;
