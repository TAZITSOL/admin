...
const AttachmentModal = (props) => {
    ...
    return (
        <ShowModal open={modal} setModal={setModal} modalAttr={{ className: "media-modal modal-dialog modal-dialog-centered modal-xl" }} close={true} title={"insert_media"} noClass={true}
                                ...
                                {({ values, setFieldValue, errors }) => (
                                    <Form className="theme-form theme-form-2 mega-form">
                                        ...
                                        <div className="modal-footer">
                                            ...
                                            <Btn type="submit" className="ms-auto" title="insert_media" loading={Number(isLoading)} />
                                        </div>
                                    </Form>
                                )}
                            </Formik>
