                ...
                {({ values, setFieldValue }) => (
                    <Form className='row'>
                        ...
                        <div className='country-input mb-4'>
                            <SimpleInputField nameList={[{ name: "phone", type: "number", placeholder: "enter_phone_number", require: "true" }]} />
                            ...
                            /></div>
                        <SimpleInputField nameList={[{ name: "street", placeholder: "enter_address", title: "address", require: "true" }]} />
                        <SearchableSelectInput
                            nameList={[
                                {
                        ...
                        <SimpleInputField nameList={[{ name: "pincode", title: "pincode", require: "true", type: 'number', placeholder: "enter_pincode" }]} />
