        ...
        <>
            ...
            {cloneVariation?.product?.wholesale_price_type &&
                <>
                    <Table className='table mt-2 mb-4 modal-table'>
                        <thead>
                            <tr>
                                ...
                                <th className="border-top-0">{(cloneVariation?.product?.wholesale_price_type == 'fixed' ? 'Unit Price' : t('percentage'))}</th>
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    <h4>{t('total_price')} <span className="theme-color">{convertCurrency(cloneVariation?.totalPrice)}</span></h4>
                </>
            }
            <div className="mt-2" >
