        ...
        {active == 1 && (
          <>
            <div className="rule-edit-form">
              <SimpleInputField nameList={[{ name: "[values][sms_methods][twilio][title]", placeholder: t("enter_title"), title: "title" }]} />
              <CheckBoxField name="[values][sms_methods][twilio][status]" title="status" />
              <SimpleInputField
                nameList={[
                  { name: "[values][sms_methods][twilio][twilio_sid]", placeholder: t("enter_twilio_sid"), title: "twilio_sid" },
                  { name: "[values][sms_methods][twilio][twilio_auth_token]", placeholder: t("enter_twilio_auth_token"), title: "twilio_auth_token" },
                  { name: "[values][sms_methods][twilio][twilio_number]", placeholder: t("enter_twilio_number"), title: "twilio_number" },
                ]}
              />
            </div>
          </>
