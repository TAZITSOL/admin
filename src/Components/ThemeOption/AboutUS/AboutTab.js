...
const AboutTab = ({ values, setFieldValue }) => {
    ...
    return (
        <>
            ...
            <FileUploadField name="content_left_image_url" title='left_bg_image' id="content_left_image_url" showImage={values['content_left_image_url']} type="file" values={values} setFieldValue={setFieldValue} helpertext={getHelperText('512x438px')} />
            <FileUploadField name="content_right_image_url" title='right_bg_image' id="content_right_image_url" showImage={values['content_right_image_url']} type="file" values={values} setFieldValue={setFieldValue} helpertext={getHelperText('512x438px')} />
            <SimpleInputField
                nameList={[
