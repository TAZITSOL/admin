                                    ...
                                    <div className="rule-edit-form">
                                        ...
                                        <SimpleInputField
                                            nameList={[
                                                ...
                                                { name: `[options][about_us][team][members][${index}][instagram]`, title: 'instagram', placeholder: t('enter_instagram_url') }, { name: `[options][about_us][team][members][${index}][twitter]`, title: 'Twitter', placeholder: t('EnterTwitter') },
                                                { name: `[options][about_us][team][members][${index}][pinterest]`, title: 'pinterest', placeholder: t('enter_pinterest_url') }, { name: `[options][about_us][team][members][${index}][facebook]`, title: 'Facebook', placeholder: t('EnterFacebook') },
                                            ]}
                                        />
                                    </div>
                                )}
